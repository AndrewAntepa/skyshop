...
public class StorageService {
    ...
    private void fillInTheTestData(){
        SimpleProduct product1 = new SimpleProduct("Сыр", UUID.randomUUID(), 100);
        DiscountedProduct product2 = new DiscountedProduct("Молоко", UUID.randomUUID(), 500, 20);
        DiscountedProduct product3 = new DiscountedProduct("Хлеб", UUID.randomUUID(), 300, 40);
        SimpleProduct product3_2 = new SimpleProduct("Хлеб", UUID.randomUUID(), 300);
        FixPriceProduct product4 = new FixPriceProduct("Вода", UUID.randomUUID());
        FixPriceProduct product5 = new FixPriceProduct("Кола", UUID.randomUUID());
        SimpleProduct product6 = new SimpleProduct("Кола", UUID.randomUUID(), 600);
        ...
        Article article5 = new Article("Название cn", "Текст статьи 4",  UUID.randomUUID());
        Article article6 = new Article("Название co", "Текст статьи 4",  UUID.randomUUID());
